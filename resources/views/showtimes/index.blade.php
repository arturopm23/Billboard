                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    <a href="{{ route('movies.show', $showtime->movie->id) }}" class="text-indigo-600 hover:text-indigo-900">{{ $showtime->movie->title }}</a>
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    <a href="{{ route('theaters.show', $showtime->theater->id) }}" class="text-indigo-600 hover:text-indigo-900">{{ $showtime->theater->name }}</a>
                                </td>
